                        ...
                        <div class="form-row">
                            <div class="row">
                                <div class="col-xl-6 col-lg-8 col-md-10 mx-auto col-">
                                    ...
                                    <input type="text" class="input-border form-control" name="ogrenci_ad" placeholder="Öğrenci Adı Soyadı Girin">
                                </div>
                                <div class="col-xl-6 col-lg-8 col-md-10 mx-auto">
                                    <label class="">T.C Numarası</label>
                                    <input type="text" class="input-border form-control" name="ogrenci_tc_no" placeholder="Öğrenci TC No'sunu Girin">
                                </div>
                            </div>                            
                            <div class="row mt-2">
                                <div class="col-xl-6 col-lg-8 col-md-10 mx-auto">
                            ...
                            <div class="form-row col-xl-12 col-lg-8 col-md-8 mx-auto mt-2">
                                ...
                                <textarea name="ogrenci_adres" class="input-border form-control mx-md-auto" placeholder="Öğrenci Adresi Giriniz"></textarea>
                            </div>
                        </div>
                    ...
                    <form action="../admin_islem.php">
                        <div class="form-row">
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-8 col-md-10 mx-auto">
                                    <label class="">T.C Numarası</label>
                                    <input type="text" class="input-border form-control" name="ogrenci_tc" placeholder="Öğrenci TC No'sunu Girin">
                                </div>
                            </div>   
                        </div>
