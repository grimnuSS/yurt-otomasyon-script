...
<div class="col-lg-9 mx-md-5 mt-5 col-md-7 col-sm-10 mx-sm-auto">
            ...
            <div class="card-header kayit-kart">
                ...
                <div class="card-body">
                    <form action="admin_islem.php" method="POST">
                        ...
                        <button name="kasa_giris_ekle" type="submit" class="mt-3 btn kayit-in">Giriş Ekle</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <!--Kasa Çıkış Başlangıç-->
    <div class="container-fluid">
        <div class="card islemler mt-5">
            <div class="card-header kayit-kart">
                <h3 class="mt-3">Kasa Çıkış Ekle</h3>
                <hr>
                <div class="card-body">
                    <form action="admin_islem.php" method="POST">
                        <div class="form-row">
                        ...
                        <button name="kasa_cikis_ekle" type="submit" class="mt-3 btn kayit-in">Çıkış Ekle</button>
                    </form>
                </div>
            </div>
        </div>
